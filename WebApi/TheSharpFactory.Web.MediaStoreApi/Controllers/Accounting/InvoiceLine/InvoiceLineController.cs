...
{
    /// <summary>
    /// <para>API for the Accounting - Invoice Line functional area</para>
    /// </summary>
    [Produces("application/json")]
    [Area("Accounting")]
    [Route("api/[area]/[controller]")]
    public partial class InvoiceLineController : ApiControllerBase
    {
        ...
        public InvoiceLineController(IBLContainer bl) 
        {
            _bl = bl;
        }
