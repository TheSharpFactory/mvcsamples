...
{
    /// <summary>
    /// <para>API for the Media - Playlist functional area</para>
    /// </summary>
    [Produces("application/json")]
    [Area("Media")]
    [Route("api/[area]/[controller]")]
    public partial class PlaylistController : ApiControllerBase
    {
        ...
        public PlaylistController(IBLContainer bl)
        {
            _bl = bl;
        }
