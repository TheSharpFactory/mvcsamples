...
{
    /// <summary>
    /// <para>API for the Media - PlaylistTrack functional area</para>
    /// </summary>
    [Produces("application/json")]
    [Area("Media")]
    [Route("api/[area]/[controller]")]
    public partial class PlaylistTrackController : ApiControllerBase
    {
        ...
        public PlaylistTrackController(IBLContainer bl)
        {
            _bl = bl;
        }
