...
{
    /// <summary>
    /// <para>API for the People - Employee functional area</para>
    /// </summary>
    [Produces("application/json")]
    [Area("People")]
    [Route("api/[area]/[controller]")]
    public partial class EmployeeController : ApiControllerBase
    {
        ...
        public EmployeeController(IBLContainer bl)
        {
            _bl = bl;
        }
